...
bool readScores(int scores[], int size) 
{
    ...
    for (int i = 0; i < size; i++) 
    {
        ...
        while (attempts < MAX_ATTEMPTS && !validInput) 
        {
            ...
            {
                attempts++;
                printf("Invalid input. Score must be between %d and %d.",MIN_SCORE, MAX_SCORE);
...
int findMaximum(int scores[], int size) 
{
    ...
    for (int i = 1; i < size; i++) 
    {
        if (i >= size) 
        {
            printf("Error: Bounds exceeded in findMaximum.\n"); 
            return -1; 
        }
...
int findMinimum(int scores[], int size) 
{
    ...
    for (int i = 1; i < size; i++) 
    {
        if (i >= size) 
        { 
            printf("Error: Bounds exceeded in findMinimum.\n"); 
            return -1; 
        }
...
void displayScores(int scores[], int size) 
{
    ...
    for (int i = 0; i < size; i++) 
    {
        if (i >= size) 
        { 
            printf("Error: Bounds exceeded in displayScores.\n"); 
            return; 
        }
        printf("Student %d: %d\n", i + 1, scores[i]);
    }
